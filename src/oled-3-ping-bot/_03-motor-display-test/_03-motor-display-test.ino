...
int counter = 1; // main loop counter
...
void loop() {
  ...
  do {    
    ...
    u8g2.drawStr(0,63,"PIN:");
    u8g2.setCursor(23,63);
    u8g2.print(RIGHT_FORWARD_PIN);
